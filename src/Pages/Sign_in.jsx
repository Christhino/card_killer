...
/**
 * 
 * @param {user = {'first_name': 'tester', 'last_name': 'djangololo',
        'email': 'test@cardkiller.me', 'password': 'passmethekey'}} param0 
 * @returns 
 */
const alert =()=>{
  Swal.fire({
...
export const Sign_in = ({setLogoutUser}) => {  
  ...
  const sign_in = (e) => {
    ...
    e.preventDefault();
    axiox
      .post(URL_API + "ck_register/", qs.stringify({
            last_name,
            first_name,
            email,
            password,
        ...
        <Text2>Create an account for free</Text2>
            <FormLogin>
                <form
                  ...
                  onSubmit={sign_in}
                >
                    <input type="Text" name="Last name" placeholder="Last name" required className="input-container"
                      value={last_name}
                      onChange={(e) => setLast_name(e.target.value)}
                    />        
                    <input type="Text" name="First name" placeholder="First name" required className="input-containerF"
                      value={first_name}
                    ...
                    />                           
                    <button type="submit" className="button-container" redirect="true" to="/card/home" onClick={alert}>SIGN IN</button>    
                </form>
                <Text>
                    <p className="txt-624">
                    ...
                    <p className="txt-8108">
                        If you have an account: <span className="txt-81083"><Link to="/"> login </Link></span>
                    </p>
                </Text> 
            </FormLogin>
